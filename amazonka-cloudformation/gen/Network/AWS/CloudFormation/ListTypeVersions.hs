...
data ListTypeVersions =
  ListTypeVersions'
    { _ltvTypeName         :: !(Maybe Text)
    , _ltvARN              :: !(Maybe Text)
...
instance AWSRequest ListTypeVersions where
        ...
        response
          = receiveXMLWrapper "ListTypeVersionsResult"
              (\ s h x ->
                 ListTypeVersionsResponse' <$>
                   (x .@? "NextToken") <*>
...
instance Hashable ListTypeVersions where

instance NFData ListTypeVersions where
        ...
        toQuery ListTypeVersions'{..}
          = mconcat
              ["Action" =: ("ListTypeVersions" :: ByteString),
               ...
               "TypeName" =: _ltvTypeName, "Arn" =: _ltvARN,
               "NextToken" =: _ltvNextToken,
               "DeprecatedStatus" =: _ltvDeprecatedStatus,
               "Type" =: _ltvType, "MaxResults" =: _ltvMaxResults]

-- | /See:/ 'listTypeVersionsResponse' smart constructor.
data ListTypeVersionsResponse =
  ListTypeVersionsResponse'
    { _ltvrsNextToken            :: !(Maybe Text)
    , _ltvrsTypeVersionSummaries :: !(Maybe [TypeVersionSummary])
...
instance NFData ListTypeVersionsResponse where
