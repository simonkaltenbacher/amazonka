...
data ListTypeRegistrations =
  ListTypeRegistrations'
    { _ltrTypeName                 :: !(Maybe Text)
    , _ltrRegistrationStatusFilter :: !(Maybe RegistrationStatus)
...
instance AWSRequest ListTypeRegistrations where
        type Rs ListTypeRegistrations =
             ListTypeRegistrationsResponse
        request = postQuery cloudFormation
        response
          = receiveXMLWrapper "ListTypeRegistrationsResult"
              (\ s h x ->
                 ListTypeRegistrationsResponse' <$>
...
instance Hashable ListTypeRegistrations where

instance NFData ListTypeRegistrations where
        ...
        toQuery ListTypeRegistrations'{..}
          = mconcat
              ["Action" =: ("ListTypeRegistrations" :: ByteString),
               ...
               "TypeArn" =: _ltrTypeARN, "Type" =: _ltrType,
               "MaxResults" =: _ltrMaxResults]

-- | /See:/ 'listTypeRegistrationsResponse' smart constructor.
data ListTypeRegistrationsResponse =
  ListTypeRegistrationsResponse'
    { _ltrrsRegistrationTokenList :: !(Maybe [Text])
...
listTypeRegistrationsResponse pResponseStatus_ =
  ListTypeRegistrationsResponse'
    { _ltrrsRegistrationTokenList = Nothing
...
instance NFData ListTypeRegistrationsResponse where
