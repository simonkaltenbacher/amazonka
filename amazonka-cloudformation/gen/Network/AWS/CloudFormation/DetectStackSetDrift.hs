...
data DetectStackSetDrift =
  DetectStackSetDrift'
    { _dssdOperationPreferences :: !(Maybe StackSetOperationPreferences)
...
instance AWSRequest DetectStackSetDrift where
        type Rs DetectStackSetDrift =
             DetectStackSetDriftResponse
        request = postQuery cloudFormation
        response
          = receiveXMLWrapper "DetectStackSetDriftResult"
              (\ s h x ->
                 DetectStackSetDriftResponse' <$>
                   (x .@? "OperationId") <*> (pure (fromEnum s)))

instance Hashable DetectStackSetDrift where

instance NFData DetectStackSetDrift where
...
data DetectStackSetDriftResponse =
  DetectStackSetDriftResponse'
    { _dssdrsOperationId    :: !(Maybe Text)
...
detectStackSetDriftResponse
    :: Int -- ^ 'dssdrsResponseStatus'
    -> DetectStackSetDriftResponse
detectStackSetDriftResponse pResponseStatus_ =
  DetectStackSetDriftResponse'
    {_dssdrsOperationId = Nothing, _dssdrsResponseStatus = pResponseStatus_}
...
instance NFData DetectStackSetDriftResponse where
